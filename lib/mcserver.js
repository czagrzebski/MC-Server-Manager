...
class MCServer extends EventEmitter {
    ...
    readProperties = async () => {
        ...
        const propertiesFile = await fs.readFile('/home/creed/Projects/MC-Server-Manager/test-server/server.properties', 'utf-8')
            .catch((err) => {
                if (err.code === "ENOENT") {
    ...
    writeProperties = async (serverProperties) => {
        //reformat into server.properties format
        ...
        await fs.writeFile('/home/creed/Projects/MC-Server-Manager/test-server/server.properties', propertiesFile)
            .then(() => console.log())
